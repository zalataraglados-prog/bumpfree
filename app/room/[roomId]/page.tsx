            ...
            <header className="border-b border-border/60 sticky top-0 z-40 bg-background/80 backdrop-blur">
                <div className="max-w-screen-xl mx-auto px-4 h-14 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3 min-w-0">
                        ...
                        {room.is_public && !isMember && <Badge variant="secondary" className="text-xs gap-1 flex-shrink-0"><Globe className="w-3 h-3" />??</Badge>}
                    </div>
                    <div className="flex items-center gap-2 flex-shrink-0">
                        ...
                        {user ? <Link href="/dashboard"><Button variant="outline" size="sm">Dashboard</Button></Link> : <Link href="/auth/login"><Button variant="outline" size="sm">??</Button></Link>}
                    </div>
                </div>
            </header>
